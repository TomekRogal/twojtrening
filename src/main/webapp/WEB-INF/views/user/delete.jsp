                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            <div class="card-header"><h3 class="text-center font-weight-light my-4">Usuń konto</h3>
                            </div>
                            <div class="card-body">
                                <form method="post">
                                    <div class="text-center">
                                        Usunięcie konta spowoduję utratę wszystkich danych i nie może być cofnięte. Czy
                                        chcesz kontynuować?
                                    </div>
